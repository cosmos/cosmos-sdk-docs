...
In this section we describe the processing of the staking messages and the corresponding updates to the state. All created/modified state objects specified by each message are defined within the [state](./02_state_transitions) section.
...
![Delegation sequence](./delegation_sequence.svg)
...
![Unbond sequence](./unbond_sequence.svg)
...
![Begin redelegation sequence](./begin_redelegation_sequence.svg)
