...
- [Anatomy of an SDK application](../../develop/high-level-concepts/00-overview-app.md) {prereq}
- [Lifecycle of an SDK transaction](../../develop/high-level-concepts/01-tx-lifecycle.md) {prereq}
