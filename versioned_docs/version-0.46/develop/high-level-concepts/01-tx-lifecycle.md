...
:::warning
The `ValidateBasic` method on messages has been deprecated in the newest versions in favor of validating messages directly in their respective [`Msg` services](../../integrate/building-modules/03-msg-services.md#Validation).
