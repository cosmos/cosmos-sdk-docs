...
In the current Cosmos SDK documentation on the [Object-Capability Model](../01-tx-lifecycle.mdocap.md), it is stated that:
...
* [Object-Capability Model](../docs/01-tx-lifecycle.mdocap.md)
