...
* `Type() string`: Type of the message, used primarily in [events](../advanced-concepts/07-events.md). This should return a message-specific `string`, typically the denomination of the message itself.
