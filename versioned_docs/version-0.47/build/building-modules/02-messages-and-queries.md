...
* `queryRoute` is used by `BaseApp`'s [`queryRouter`](../../develop/advanced/00-baseapp.md#grpc-query-router) to map the `query` to its module. Usually, `queryRoute` should be the name of the module.
...
* A [`querier`](04-query-services.md#query-services), to process the `query` once it has been [routed to the module](../../develop/advanced/00-baseapp.md#grpc-query-router).
