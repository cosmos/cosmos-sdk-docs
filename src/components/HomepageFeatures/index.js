...
const latestVersion = "0.50";

const FeatureList = [
  {
    title: `Learn Basics`,
    Svg: require("@site/static/img/innovation.svg").default,
    to: `/${latestVersion}/develop/intro/what-is-sdk`,
    description: (
      <>
  ...
  {
    title: `Build a Chain`,
    to: `/${latestVersion}/building-apps/app-go`,
  ...
  },
  {
    ...
    to: `/${latestVersion}/build/building-modules/intro`,
  ...
  },
  {
    ...
    to: `/${latestVersion}/user/run-node/run-node`,
